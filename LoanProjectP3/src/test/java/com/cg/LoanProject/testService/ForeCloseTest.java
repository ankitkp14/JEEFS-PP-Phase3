...
public class ForeCloseTest {
	...
	@Test
	@DisplayName("ForeClose Successful")
	public void foreCloseTest() {
		String response = null;
		
		try {
			if(service.foreClose("79391001004")!=null){
				response="Success";
			}
		}catch (Exception ex){
	...
	public void forecloseWithoutLoanTest() {
		//exception
		assertThrows(LoanHandlingExceptions.class, () -> {
			service.foreClose("79391001005");
		});
	}
}